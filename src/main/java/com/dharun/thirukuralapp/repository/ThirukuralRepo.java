package com.dharun.thirukuralapp.repository;
...
public class ThirukuralRepo {
	...
	public Thirukural getThirukural(int kuralEnn, String author) {
		...
		Thirukural thirukural = new Thirukural(kuraljsonObject,author);
		return thirukural;
		}
	...
	public List<Thirukural> getAdhigaramKural(long start) {
		...
		try {
			...
			while(startIndex<10) {
				...
				Thirukural thirukural = new Thirukural(kuraljsonObject,"mv");
				start++;
				startIndex++;
